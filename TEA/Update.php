...
curl_setopt($github, CURLOPT_URL, "http://github.com/dc/markdown.sugar/raw/master/Languages.xml");
...
if ($version == $remote_version):
	...
	echo "\nMarkdown Sugar {$remote_version} is available, you have {$version}.\nDownload it here: http://github.com/dc/markdown.sugar\n\n";
endif;
